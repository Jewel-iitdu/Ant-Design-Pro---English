...
/**
 * Current user access; if it is empty, the user is not logged in.
 * For the Pro preview, the user is considered to have permissions by default.
 */
...
// The code is compatible with both local service mock and static data on the deployed site
export default {
  // Supports values of type Object and Array
  'GET /api/currentUser': (_req: Request, res: Response) => {
    ...
    res.send({
      ...
      data: {
        ...
        signature: 'Strive to be inclusive and open-minded',
