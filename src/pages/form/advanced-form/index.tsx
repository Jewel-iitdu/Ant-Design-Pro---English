...
const AdvancedForm: FC<Record<string, any>> = () => {
  ...
  return (
    ...
    >
      <PageContainer content="Advanced forms are common when entering and submitting large amounts of data at once.">
        <Card title="Warehouse management" className={styles.card} variant="borderless">
          <Row gutter={16}>
