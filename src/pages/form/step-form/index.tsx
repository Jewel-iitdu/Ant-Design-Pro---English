...
const StepDescriptions: React.FC<{
  ...
  return (
    <Descriptions column={1} bordered={bordered}>
      <Descriptions.Item label="Paying account"> {payAccount}</Descriptions.Item>
      <Descriptions.Item label="Receiving account">
        {' '}
        {receiverAccount}
      </Descriptions.Item>
      <Descriptions.Item label="Recipient name"> {receiverName}</Descriptions.Item>
...
const StepResult: React.FC<{
  ...
  return (
    <Result
      ...
      subTitle="The funds are expected to arrive within two hours."
      extra={
        <>
...
const StepForm: React.FC<Record<string, any>> = () => {
  ...
  return (
    <PageContainer content="Split a long or unfamiliar form task into multiple steps to guide the user to complete it.">
      <Card variant="borderless">
          ...
          >
            <ProFormSelect
              ...
              rules={[
                {
                  required: true,
                  message: 'Please select a paying account',
                },
              ]}
              valueEnum={{
          ...
          <StepsForm.StepForm title="Confirm transfer information">
            <div className={styles.result}>
              <Alert
                closable
                showIcon
                message="After confirming the transfer, the funds will be deposited directly into the other party's account and cannot be returned."
                style={{
                  marginBottom: 24,
                }}
              />
              ...
              <ProFormText.Password
                ...
                rules={[
                  {
                    required: true,
                    message: 'Payment password is required to complete the transfer',
                  },
                ]}
              />
            </div>
        ...
        <div>
          ...
          <p>
            If needed, you can place some frequently asked questions about the product
            here. If needed, you can place some frequently asked questions about the
            product here. If needed, you can place some frequently asked questions
